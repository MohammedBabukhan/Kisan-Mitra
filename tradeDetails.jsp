...
<body>
    ...
    <div class="container">
        <a href="showingtrade.jsp" class="back-link">
                ...
                <div class="trade-details">
                    ...
                    <div class="price-section">
                        <div class="price-row">
                            ...
                            <div class="price-value">?<%= String.format("%,.2f", trade.get("buyingprice")) %></div>
                        </div>
                        <div class="price-row">
                            <div class="price-label">GST (5%):</div>
                            <div class="price-value">?<%= String.format("%,.2f", (Double)trade.get("buyingprice") * 0.05) %></div>
                        </div>
                        <div class="total-price">?<%= String.format("%,.2f", (Double)trade.get("buyingprice") * 1.05) %> per MT</div>
                    </div>
        ...
        <% } else { %>
            <div class="no-trade">
                ...
                <a href="viewtrade.jsp" class="back-link"><i class="fas fa-store"></i> Return to Marketplace</a>
            </div>
        <% } %>
    </div>
